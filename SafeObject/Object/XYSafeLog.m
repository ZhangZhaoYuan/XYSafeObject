...
static const NSString *XYCrashSeparatorWithFlag = @">>>>>>>>>>>>>>>>>>>>>>>> XYCrashProtector <<<<<<<<<<<<<<<<<<<<<<<<";

@implementation XYSafeLog
...
+ (void)xy_noteErrorWithException:(NSException *)exception attachedTODO:(NSString *)todo {
    ...
    NSString *logErrorMessage = [NSString stringWithFormat:@"\n\n%@\n\n%@\n%@\n%@\n%@\n%@\n",XYCrashSeparatorWithFlag, crashType, errorReason, errorPlace, crashProtector, exception.callStackSymbols];
